        ...
        <div class="flex h-16 justify-between">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2 font-bold text-slate-800">
                        <span class="flex h-9 w-9 items-center justify-center rounded-lg bg-cyan-700 text-lg text-white">+</span>
                        <span class="hidden lg:inline">Vật tư y tế</span>
                    </a>
                </div>
